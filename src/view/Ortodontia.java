...
public class Ortodontia extends JFrame {
    public Ortodontia() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Ortodontia.super.setVisible(false);
        ...
        btnHorarios.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	Ortodontia.this.setVisible(false);
        ...
        JLabel lblEspecialidades = new JLabel("Ortodontia");
        ...
        txtpnEspecialidade.setText("A Ortodontia é uma especialidade odontológica que identifica, previne e corrige problemas na posição dos dentes, promovendo uma oclusão adequada, alinhamento e estética das arcadas dentárias.");
        txtpnEspecialidade.setBounds(33, 200, 200, 205);
        getContentPane().add(txtpnEspecialidade);        
        
        JLabel lblNewLabel_1 = new JLabel("");
        lblNewLabel_1.setIcon(new ImageIcon(getClass().getResource("/imagens/Ortodontia.jpg")));
        lblNewLabel_1.setBounds(350, 125, 356, 261);
