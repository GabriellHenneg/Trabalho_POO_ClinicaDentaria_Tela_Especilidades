    ...
    public Implantodontia() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		Implantodontia.super.setVisible(false);
        ...
        JLabel lblEspecialidades = new JLabel("Implantodontia");
        lblEspecialidades.setForeground(new Color(0, 255, 64));
        lblEspecialidades.setFont(new Font("Agency FB", Font.PLAIN, 34));
        lblEspecialidades.setBounds(33, 130, 161, 60);
        getContentPane().add(lblEspecialidades);

        JTextPane txtpnEspecialidade = new JTextPane();
        txtpnEspecialidade.setForeground(new Color(0, 0, 0));
        txtpnEspecialidade.setFont(new Font("Agency FB", Font.PLAIN, 20));
        txtpnEspecialidade.setBackground(new Color(240, 240, 240));
        txtpnEspecialidade.setText("Esta é a especialidade da odontologia que tem conhecido os maiores avanços nos últimos anos e é das mais procuradas pela sua crescente confiabilidade; os implantes consistem na substituição do dente natural através da colocação de uma raíz artificial de titânio. Esta raíz permite suportar um novo dente.");
        txtpnEspecialidade.setBounds(33, 200, 221, 253);
        getContentPane().add(txtpnEspecialidade);        
        
        JLabel lblNewLabel_1 = new JLabel("");
        lblNewLabel_1.setIcon(new ImageIcon(getClass().getResource("/imagens/Implantodontia.jpg")));
        lblNewLabel_1.setBounds(388, 173, 214, 261);
        ...
        btnVoltarParaAsEspecialidades.setBounds(278, 45, 161, 27);
