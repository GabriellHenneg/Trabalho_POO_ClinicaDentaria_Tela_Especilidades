...
public class ProteseRemovivel extends JFrame {
    public ProteseRemovivel() {
        ...
        btnNewButton.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		ProteseRemovivel.super.setVisible(false);
        ...
        btnHorarios.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	ProteseRemovivel.this.setVisible(false);
        ...
        txtpnEspecialidade.setText("As próteses removíveis, como o próprio nome indica, são facilmente removidas e inseridas pelo próprio paciente sem intervenção do dentista. Apóiam-se diretamente na gengiva ou nos dentes, constituídas apenas de Acrílico, ou Prótese Removíveis Esqueléticas, Metal mais Acrílico.");
        txtpnEspecialidade.setBounds(33, 200, 200, 205);
        getContentPane().add(txtpnEspecialidade);        
        
        JLabel lblNewLabel_1 = new JLabel("");
        lblNewLabel_1.setIcon(new ImageIcon(getClass().getResource("/imagens/PróteseRemovível.jpg")));
        lblNewLabel_1.setBounds(315, 125, 356, 261);
        ...
        btnVoltarParaAsEspecialidades.setBounds(274, 45, 159, 27);
